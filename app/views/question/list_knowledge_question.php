    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
            ...
            <div class="row">
                <h3 class="col-md-10 card-title">
                    <?php 
                      ...
                      echo $lang['bank_questions_knowledge'].$kn['name']; 
                    ?>
                </h3>
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <table id="questions_knowledge" class="table table-bordered table-hover">
              <thead>
              <tr>
              ...
              <tbody>
               <?php
                $questions = $h->getQuestionsByKnowledge($pqh[1]);
                $msg_question = '';
