<?php
    ...
    $def = array(
        ...
        'link_process_check_info' => URL.'thi-trac-nghiem/process/check_info.php',
        ...
        'link_process_import_profile' => URL.'app/process/profile/import.php',
        ...
        'sizebar_quiz' => 'app/sidebar/sizebar_quiz.php',
        'nav-flat' => 'nav-flat',
        ...
        'link_import_profile' => 'nhap-nhan-vien-bang-file-exel',
        ...
        'link_question_knowledge' => 'ngan-hang-de-thi-theo-kien-thuc',
        ...
        'views' => 'app/views/',
        'link_the_quiz' => 'thi-trac-nghiem',
        'link_logout_quiz' => 'logout-quiz',
        'check_quiz' => 'kiem-tra-thong-tin-ki-thi',
        'quiz' => 'thi',
        'link_process_create_quiz' => URL.'app/process/quiz/create_exam_profile.php',
        'link_update_time_remaining' => URL.'app/process/quiz/update_time_remaining.php',
        'link_update_answer_question' => URL.'app/process/quiz/update_answer_question.php',
        'link_process_end_quiz' => URL.'app/process/quiz/end_quiz.php',
